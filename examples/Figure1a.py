...
if __name__ == "__main__":
    ...
    wires = [
        ...
        Wire((74, 74), (74, 45), vertical_eqs, cartesian_variables, LOW_WIRE_RESISTANCE),
        Wire((74, 45), (74, 26), vertical_eqs, cartesian_variables, HIGH_WIRE_RESISTANCE),
        Wire((74, 26), (38, 26), horizontal_eqs, cartesian_variables, LOW_WIRE_RESISTANCE),
        Wire((30, 26), (26, 26), horizontal_eqs, cartesian_variables, LOW_WIRE_RESISTANCE),
    ...
    world.show_circuit(
        {0: (26, 26), 1: (26, 74), 2: (60, 74), 3: (74, 74), 4: (74, 45), 5: (74, 26), 6: (38, 26), 7: (30, 26) }
    )
